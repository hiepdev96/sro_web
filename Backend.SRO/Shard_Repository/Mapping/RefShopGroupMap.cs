...
{
    public partial class RefShopGroupMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefShopGroup>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefShopGroup> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefShopGroup", "dbo");

            // key
            builder.HasKey(t => new { t.Country, t.Id, t.RefNPCCodeName });
            ...
            builder.Property(t => t.RefNPCCodeName)
                .IsRequired()
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithMany(t => t.CountryRefShopGroups)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefShopGroup";
        }
        ...
        public struct Columns
        {
            ...
            public const string RefNPCCodeName = "RefNPCCodeName";
