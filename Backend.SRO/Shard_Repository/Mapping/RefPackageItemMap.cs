...
{
    public partial class RefPackageItemMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefPackageItem>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefPackageItem> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefPackageItem", "dbo");
            ...
            builder.Property(t => t.SaleTag)
                .IsRequired()
                .HasColumnName("SaleTag")
                .HasColumnType("smallint");

            builder.Property(t => t.ExpandTerm)
                .IsRequired()
                .HasColumnName("ExpandTerm")
                .HasColumnType("varchar(65)")
                .HasMaxLength(65)
                .HasDefaultValueSql("('xxx')");

            builder.Property(t => t.NameStrID)
                .IsRequired()
            ...
            builder.Property(t => t.DescStrID)
                .IsRequired()
            ...
            builder.Property(t => t.AssocFileIcon)
                .IsRequired()
                .HasColumnName("AssocFileIcon")
                .HasColumnType("varchar(129)")
                .HasMaxLength(129)
                .HasDefaultValueSql("('xxx')");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithMany(t => t.CountryRefPackageItems)
                .HasForeignKey(d => d.Country)
                .HasConstraintName("FK___RefPacka__Count__107505DE");
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefPackageItem";
        }
        ...
        public struct Columns
        {
            ...
            public const string SaleTag = "SaleTag";
            public const string ExpandTerm = "ExpandTerm";
            public const string NameStrID = "NameStrID";
            public const string DescStrID = "DescStrID";
            public const string AssocFileIcon = "AssocFileIcon";
