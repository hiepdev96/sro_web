...
{
    public partial class RefAccessPermissionOfShopMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefAccessPermissionOfShop>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefAccessPermissionOfShop> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefAccessPermissionOfShop", "dbo");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithOne(t => t.CountryRefAccessPermissionOfShop)
                .HasForeignKey<VsroShard.Shard_Repository.Entities.RefAccessPermissionOfShop>(d => d.Country)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefAccessPermissionOfShop";
        }
