...
{
    public partial class RefTreatItemOfShopMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefTreatItemOfShop>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefTreatItemOfShop> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefTreatItemOfShop", "dbo");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithMany(t => t.CountryRefTreatItemOfShops)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefTreatItemOfShop";
        }
