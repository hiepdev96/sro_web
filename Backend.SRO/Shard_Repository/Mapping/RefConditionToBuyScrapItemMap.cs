...
{
    public partial class RefConditionToBuyScrapItemMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefConditionToBuyScrapItem>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefConditionToBuyScrapItem> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefConditionToBuyScrapItem", "dbo");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithOne(t => t.CountryRefConditionToBuyScrapItem)
                .HasForeignKey<VsroShard.Shard_Repository.Entities.RefConditionToBuyScrapItem>(d => d.Country)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefConditionToBuyScrapItem";
        }
