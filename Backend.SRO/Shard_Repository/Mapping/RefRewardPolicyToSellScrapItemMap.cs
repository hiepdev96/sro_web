...
{
    public partial class RefRewardPolicyToSellScrapItemMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefRewardPolicyToSellScrapItem>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefRewardPolicyToSellScrapItem> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefRewardPolicyToSellScrapItem", "dbo");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithMany(t => t.CountryRefRewardPolicyToSellScrapItems)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefRewardPolicyToSellScrapItem";
        }
