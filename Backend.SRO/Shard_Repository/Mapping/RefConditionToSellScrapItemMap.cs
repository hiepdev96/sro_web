...
{
    public partial class RefConditionToSellScrapItemMap
        : IEntityTypeConfiguration<VsroShard.Shard_Repository.Entities.RefConditionToSellScrapItem>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<VsroShard.Shard_Repository.Entities.RefConditionToSellScrapItem> builder)
        {
            #region Generated Configure
            // table
            builder.ToTable("_RefConditionToSellScrapItem", "dbo");
            ...
            builder.HasOne(t => t.CountryRefShopObject)
                .WithOne(t => t.CountryRefConditionToSellScrapItem)
                .HasForeignKey<VsroShard.Shard_Repository.Entities.RefConditionToSellScrapItem>(d => d.Country)
        ...
        public struct Table
        {
            ...
            public const string Name = "_RefConditionToSellScrapItem";
        }
