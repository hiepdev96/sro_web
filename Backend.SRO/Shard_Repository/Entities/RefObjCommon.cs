...
namespace VsroShard.Shard_Repository.Entities
{
    public partial class RefObjCommon
    {
        public RefObjCommon()
        {
            ...
            RefItemRefDropItemGroups = new HashSet<RefDropItemGroup>();
            RefItemRefMonsterAssignedItemDrops = new HashSet<RefMonsterAssignedItemDrop>();
            RefMonsterRefCustomizingReservedItemDropForMonsters = new HashSet<RefCustomizingReservedItemDropForMonster>();
            RefMonsterRefMonsterAssignedItemDrops = new HashSet<RefMonsterAssignedItemDrop>();
            RefMonsterRefMonsterAssignedItemRndDrops = new HashSet<RefMonsterAssignedItemRndDrop>();
            #endregion
        }
        ...
        public string AssocFile1128 { get; set; }

        public string AssocFile2128 { get; set; }
        ...
        public virtual ICollection<RefDropItemGroup> RefItemRefDropItemGroups { get; set; }

        public virtual ICollection<RefMonsterAssignedItemDrop> RefItemRefMonsterAssignedItemDrops { get; set; }

        public virtual ICollection<RefCustomizingReservedItemDropForMonster> RefMonsterRefCustomizingReservedItemDropForMonsters { get; set; }

        public virtual ICollection<RefMonsterAssignedItemDrop> RefMonsterRefMonsterAssignedItemDrops { get; set; }

        public virtual ICollection<RefMonsterAssignedItemRndDrop> RefMonsterRefMonsterAssignedItemRndDrops { get; set; }
